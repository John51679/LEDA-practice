...
int main(){
	graph G;
	/*Making the initial square (before for loop)*/
	node v1 = G.new_node();
	node v2 = G.new_node();
	node v3 = G.new_node();
	node v4 = G.new_node();
	...
	edge e3 = G.new_edge(v3,v4);
	edge e4 = G.new_edge(v4,v1);

	node vt1,vt2,vt3,vt4;
	edge elink1,elink2,elink3,elink4;
	for (int i = 0; i < (int)(NODES/4) - 1; i++){ /*The rest of the squares will be made within this for loop*/
		vt1 = v1;
		vt2 = v2;
		vt3 = v3;
		vt4 = v4;
		...
		elink1 = G.new_edge(vt1,v1);
		elink2 = G.new_edge(vt2,v2);
		elink3 = G.new_edge(vt3,v3);
		elink4 = G.new_edge(vt4,v4);
